/**
 * Contact Component
 * Contact form with validation and contact information display
 */
    ...
    const contactInfo = [
        {
            ...
            label: "Email",
            value: "saikumarkalva10@gmail.com",
        ...
        },
        {
            ...
            label: "LinkedIn",
            value: "linkedin.com/in/saikumar1002",
            href: "https://www.linkedin.com/in/saikumar1002"
        },
        {
            icon: (
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
            ...
            label: "GitHub",
            value: "github.com/Saikumar-2002",
            href: "https://github.com/Saikumar-2002"
        }
    ];
                        ...
                        <form action="https://formspree.io/f/xojprloo" className="contact__form" onSubmit={handleSubmit}>
                            ...
                            <div className={`contact__form-group ${errors.email ? 'contact__form-group--error' : ''}`}>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="contact__form-input"
                                    placeholder="saikumar@email.com"
                                />
